...
import { Avatar, AvatarImage, AvatarFallback, Button, Input, cn } from '@taskflow/ui';
import { formatProgressTime } from '../../utils/date';
import { haptics } from '../../utils/haptics';
import type { ProgressUpdateWithComments, TaskMessageWithSender } from '@taskflow/core';
...
export function ProgressEntry({
  ...
  return (
    <m.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="py-3">
      {/* Time */}
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="font-medium text-sm">{update.sender?.name || 'Unknown'}</span>
        </div>
