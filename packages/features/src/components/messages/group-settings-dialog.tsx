...
import type { ConversationWithMembers, UserBasic } from '@taskflow/core';
...
export function GroupSettingsDialog({
  ...
  const handleAvatarChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    await uploadGroupAvatar.mutateAsync({ conversationId: conversation.id, file });
    e.target.value = '';
  };
