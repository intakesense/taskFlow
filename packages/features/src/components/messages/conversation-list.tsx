...
import { useFormattedTimestamp } from '../../utils/global-clock';
...
interface ConversationListProps {
  ...
  /** Optional header action buttons (e.g., AI voice chat button) */
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="lg:hidden text-lg font-bold text-foreground">
                TaskFlow
              </h1>
              {/* Messages - desktop only */}
              <h2 className="hidden lg:block text-xl font-bold text-foreground">
                Messages
              </h2>
...
function ConversationItem({
  ...
  const { initials, imageUrl } = getConversationAvatar(
    conversation,
    currentUserId
  );
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          {unread > 0 && (
            <Badge className={cn(
              "ml-2 bg-primary text-primary-foreground flex-shrink-0 min-w-[22px] h-[22px] justify-center text-xs font-semibold",
...
function getConversationName(
  ...
  if (
    ...
    conv.members[0].id === currentUserId
  ) {
...
function getConversationAvatar(
  conv: ConversationWithMembers,
  currentUserId?: string
): { initials: string; imageUrl?: string } {
  if (conv.is_group) {
    return {
...
export { getConversationName, getConversationAvatar };
