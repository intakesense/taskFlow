...
import { Avatar, AvatarImage, AvatarFallback, cn, messageBubbleVariants } from '@taskflow/ui';
 ...
 *
 * For file attachments and audio playback, pass platform-specific render props:
 * - renderFileAttachment: Renders images, videos, and document previews
 * - renderAudioPlayer: Renders voice message player
 */
    ...
    >
      ...
      {isGroupChat && !isOwn && (
        <div className="w-8 mr-2 flex-shrink-0 self-end">
          {showAvatar ? (
            <Avatar
              className={cn('h-8 w-8', onAvatarClick && 'cursor-pointer')}
              onClick={
                onAvatarClick
                  ? () => {
                      haptics.light();
      ...
      <div
        ...
        className={cn(
          ...
          isGroupChat &&
            !isOwn &&
            'max-w-[calc(80%-40px)] sm:max-w-[calc(70%-40px)]'
        )}
      ...
      >
        ...
        {message.file_url ? (
          <div className="space-y-1">
            {isVoiceMessage && renderAudioPlayer ? (
              renderAudioPlayer({
              ...
              >
                <p className="text-sm underline truncate">
            ...
            {message.content && !isVoiceMessage && (
              ...
              >
                <p className="text-sm whitespace-pre-wrap break-words">
                  {renderMentions(message.content, users)}
                </p>
                <div
                  className={cn(
