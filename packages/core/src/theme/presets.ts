...
import type { ThemeConfig, ThemeColors, ThemeEffects, ThemeFonts } from './types';
...
const y2kLightColors: ThemeColors = {
  ...
  primaryForeground: 'oklch(1 0 0)',
  secondary: 'oklch(0.85 0.2 180)',
  secondaryForeground: 'oklch(0.2 0 0)',
  accent: 'oklch(0.9 0.2 100)',
...
export const THEME_PRESETS: Record<string, ThemeConfig> = {
  modern: {
    preset: 'modern',
    mode: 'system',
    colors: { light: shadcnLightColors, dark: shadcnDarkColors },
  ...
  glass: {
    preset: 'glass',
    mode: 'system',
    colors: { light: glassLightColors, dark: glassDarkColors },
  ...
  neumorphism: {
    preset: 'neumorphism',
    mode: 'system',
    colors: { light: neumorphismLightColors, dark: neumorphismDarkColors },
  ...
  y2k: {
    preset: 'y2k',
    mode: 'system',
    colors: { light: y2kLightColors, dark: y2kDarkColors },
    effects: y2kEffects,
