...
function LoginPageContent() {
    ...
    // Handle OAuth callback - show loading state while code is being processed
    useEffect(() => {
    ...
    // Redirect to home if user becomes authenticated (handles Google OAuth)
    useEffect(() => {
        if (!loading && user) {
            // Only show toast for Google login (when isGoogleLoading is true)
            // Email login shows its own toast in onSubmit
            if (isGoogleLoading) {
    ...
    const handleGoogleSignIn = async () => {
        ...
        // No need to handle success - OAuth will redirect
    }
