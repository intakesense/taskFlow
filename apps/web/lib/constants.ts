...
export const VISIBILITY_LABELS = {
  [Visibility.PRIVATE]: 'Private (Assignee only)',
  [Visibility.SUPERVISOR]: 'Supervisor',
  [Visibility.HIERARCHY_SAME]: 'Same level & above',
  [Visibility.HIERARCHY_ABOVE]: 'Above level only',
